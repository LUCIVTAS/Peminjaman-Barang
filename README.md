...
1. **Buat Proyek**: Buka [Firebase Console](https://console.firebase.google.com/) dan buat proyek baru.
2. **File Konfigurasi**: Unduh `google-services.json` dan letakkan di direktori `android/app/`.
3. **Service Account (FCM V1)**:
